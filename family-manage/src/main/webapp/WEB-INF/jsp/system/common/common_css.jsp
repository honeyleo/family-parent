...
<!-- ace styles -->
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/ace/assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />

<!--[if lte IE 9]>
	<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/ace/assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
<![endif]-->
...
<script src="<%=request.getContextPath() %>/resources/ace/assets/js/ace-extra.min.js"></script>
