...
public class RedisClient {
	...
	public RedisClient(String ip, int prot) {
		if (pool == null) {
			...
			pool = new JedisPool(config, ip, prot, 1000);
		}
	}
	 ...
	 * 
	 * <p>
	 * obj.mset(newString[]{"key2","value1","key2","value2"})
	 * </p>
	 * 
	 * @param keysvalues
	 * @return成功返回OK失败异常返回 null
	 * 
	 */
	 ...
	 * 
	 * <p>
	 * obj.msetnx(newString[]{"key2","value1","key2","value2"})
	 * </p>
	 * 
	 * @param keysvalues
	 * @return成功返回1失败返回0
	 ...
	 * 
	 * <p>
	 * 通过下标和key获取指定下标位置的 value
	 * </p>
	 * 
	 * @param key
	 * @param startOffset开始位置从0开始负数表示从右边开始截取
	 * @param endOffset
	 * @return如果没有返回null
	 */
	 ...
	 * 
	 * <p>
	 * 通过key 和 fields 获取指定的value如果没有对应的value则返回null
	 * </p>
	 * 
	 * @param key
	 * @param fields可以使一个String也可以是
	 *            String数组
	 * @return
	 */
	 ...
	 * 
	 * @param key
	 * @param strs可以使一个string也可以使string数组
	 * @return返回list的value个数
	 */
	 ...
	 * 
	 * <p>
	 * 通过key从对应的list中删除指定的count个和 value相同的元素
	 * </p>
	 * 
	 * @param key
	 * @param count当count为0时删除全部
	 * @param value
	 * @return返回被删除的个数
	 */
	 ...
	 * 
	 * <p>
	 * 如果start 为 0 end 为-1则返回全部的list中的value
	 * </p>
	 * 
	 * @param key
	 * @param start
	 ...
	 * 
	 * @param key
	 * @param members可以是一个String也可以是一个String数组
	 * @return添加成功的个数
	 */
	 ...
	 * </p>
	 * 
	 * @param keys可以使一个string则返回set中所有的value也可以是string数组
	 * @return
	 */
	 ...
	 * </p>
	 * 
	 * @param keys可以使一个string也可以是一个string数组
	 * @return
	 */
	 ...
	 * 
	 * @param key
	 * @param members可以使一个string也可以是一个string数组
	 * @return
	 */
	 ...
	 * @return
	 */
	public List<GeoRadiusResponse> georadius(String key, String member, Double radius, GeoUnit unit) {
		Jedis jedis = null;
		List<GeoRadiusResponse> res = null;
		try {
			jedis = pool.getResource();
	 ...
	 * @return
	 */
	public List<GeoRadiusResponse> georadius(String key, String member, Double radius, GeoUnit unit, GeoRadiusParam param) {
		Jedis jedis = null;
		List<GeoRadiusResponse> res = null;
		try {
			jedis = pool.getResource();
	...
	public static void main(String[] args) throws Exception {
		RedisClient r = new RedisClient("127.0.0.1", 6379);
